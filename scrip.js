...
function filaEstagiarios() {
    alert("Alerta, o botão destinado a alguns links de acesso tais como; Sgar, Xibo, Fila Estagiarios e Plantonistas só funcionam na rede cabeada, Smartphones não terão acesso ao redimensionamento através dos botões de acesso.");
